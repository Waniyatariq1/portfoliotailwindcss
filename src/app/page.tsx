    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-2 bg-gray-100">
      ...
      <div className="w-32 h-32 mb-4 text-blue-500">
        <Image 
          ...
          alt="Profile Picture of Waniya Tariq"
      ...
      <h1 className="text-4xl font-bold mb-4 text-purple-600">Hello I am Waniya Tariq</h1>
...
//   return (
//     <div className="flex flex-col items-center justify-center min-h-screen py-2 bg-gray-100">
//       <h1 className="text-4xl font-bold mb-4">Hello, I am Waniya Tariq</h1>
